    ...
    <div>
      <div className=" flex justify-between py-[9.5px] pr-[10px] pl-8 bg-[#FEFEFE] rounded-[15px] shadow-[0_16px_30px_-10px_rgba(70,96,187,0.20)] mb-6">
        <div className=" flex gap-6">
          <img width={24} height={24} src="/search.svg" alt="search-icon" />
          <input
            value={input}
            onChange={(e) => setInput(e.target.value)}
            className=" w-[260px] outline-none placeholder:text-[#4B6A9B] placeholder:text-[18px] leading-[25px] "
            type="text"
        ...
        <button
          onClick={handleClick}
          className=" bg-[#0079FF] text-white font-bold rounded-[10px] px-[23.5px] py-[13px] text-base "
        >
          Search
        </button>
      </div>
      <div className="rounded-[15px] bg-[#FEFEFE] flex justify-between shadow-[0_16px_30px_-10px_rgba(70,96,187,0.20)] p-12 ">
        <div className="rounded-[50%]">
          <img className="rounded-[50%]" src="/img.svg" alt="" />
        </div>
        <div>
          ...
          <p className=" text-[#0079FF] text-[16px] mb-5">@octocat</p>
          <p className=" text-[#4B6A9B] text-[15px] leading-[25px] opacity-75 mb-8  ">
            This profile has no bio
          </p>
          <div className=" flex justify-between bg-[#F6F8FF] rounded-[10px] w-full py-4 px-8 mb-[37px]">
            <div className=" flex flex-col">
              <p className="text-[#4B6A9B] text-[13px]">Repos</p>
              <p className=" text-[#2B3442] text-[22px] font-bold ">8</p>
            </div>
            <div className=" flex flex-col">
              <p className="text-[#4B6A9B] text-[13px]">Followers</p>
              <p className=" text-[#2B3442] text-[22px] font-bold ">3938</p>
            </div>
            <div className=" flex flex-col">
              <p className="text-[#4B6A9B] text-[13px]">Following</p>
              <p className=" text-[#2B3442] text-[22px] font-bold ">9</p>
            </div>
          </div>
          <div className="flex justify-between items-center mb-5 ">
            <div className=" flex gap-5">
              ...
              <p className="text-[#4B6A9B] text-[15px]">San Francisco</p>
            </div>
            <div className=" flex gap-4 w-[45%]">
              ...
              <p className="text-[#4B6A9B] text-[15px]">Not Available</p>
            </div>
          </div>
          <div className="flex justify-between items-center ">
            <div className=" flex gap-4">
              ...
              <p className="text-[#4B6A9B] text-[15px]">https://github.blog</p>
            </div>
            <div className=" flex gap-4 w-[45%]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-[#4B6A9B] text-[15px]">@github</p>
            </div>
          </div>
        </div>
      </div>
